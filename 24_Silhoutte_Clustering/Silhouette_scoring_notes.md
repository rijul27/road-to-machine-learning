...
> Companion to `kmeans_clustering_notes.md` and `hierarchical_clustering_notes.md`. This file assumes you already know what a "cluster," "centroid," and "Euclidean distance" mean.
...
![Diagram showing point i, its own cluster with distance a(i), and the nearest neighboring cluster with distance b(i), plus the silhouette score scale from -1 to +1](images/sil_01_a_b_diagram.png)
